        ...
        return http
                ...
                .authorizeHttpRequests(auth ->
                        auth
                                ...
                                .requestMatchers(HttpMethod.POST, "/admin/items/books").permitAll()
                                .requestMatchers(HttpMethod.PUT, "/admin/items/books/{id}").permitAll()
                                .requestMatchers(HttpMethod.DELETE, "/admin/items/books/{id}").permitAll()
